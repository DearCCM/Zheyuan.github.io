...
hydragogue_mapping = { 0: "without", 1: "20mg", 2: "＞200mg"}
ebrantil_mapping = { 0: "without", 1: "with"}
natriuretic_peptide_mapping = { 0: "without", 1: "with"}
...
# User selects which content to display
    ...
    features.extend([ventilation_time, hydragogue_mapping[hydragogue], SCR, MIN_urine, HR, natriuretic_peptide, ebrantil, UREA, GLU, MCHC])
